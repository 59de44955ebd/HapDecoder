...
Valentin Schmidt 2018: implemented OpenMX support
*/
...
void ConvertBGRAtoRGBA (int width, int height, const unsigned char* a, unsigned char* b) {
	...
	//######################################
	{
		...
		const unsigned char* aa = a + (numPixels * 4 / NUM_THREADS) * thread_id;
		unsigned char* bb = b + (numPixels * 4 / NUM_THREADS) * thread_id;
		//######################################
		#pragma omp for
		//######################################
